...
>
    <div>
        ...
        <div class="mt-8 text-center">
            ...
            <span class="hidden  mt-3  text-gray-400 lg:block">Admin</span>
        </div>
        ...
        <ul class="mt-8 space-y-2 tracking-wide">
            ...
            <li>
                ...
                >
                    ...
                    <span class="group-hover:text-gray-700">Pages</span>
                </a>
            </li>
            <li>
                <a
            ...
            <li>
                ...
                >
                    ...
                    <span class="group-hover:text-gray-700">User Account</span>
                </a>
            </li>
            <li>
                <a
