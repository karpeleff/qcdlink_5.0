...
<html lang="en">
  <head>
    ...
    <meta name="description" content="hero architecture section" />
      ...
      <title>{{ config('app.name', 'qcd-link.ru') }}</title>
 ...
 <link href="{{ asset('css/app.css') }}" rel="stylesheet">
  ...
  <body class="bg-gray-100">
    <aside
      class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3
       transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]"
    >
      <div>
        <div class="-mx-6 px-6 py-4">
          <a href="#" title="home">
            <img src="/assets/img/logo.svg" class="w-32" alt="tailus logo" />
          </a>
        </div>
        ...
        <ul class="mt-8 space-y-2 tracking-wide">
          <li>
            ...
            >
              ...
              <span class="-mr-1 font-medium">Панель управления</span>
            </a>
          </li>
          <li>
            <a
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
      ...
      <div class="rounded-xl border bg-white bg-opacity-50 shadow-xl backdrop-blur-2xl">
          ...
          <form action="" class="space-y-8">
            <div class="space-y-2">
              ...
              <input
                ...
                name="email"
                id="email"
                class="focus:outline-none block w-full rounded-md border border-gray-300 px-4 py-3 text-gray-600 transition duration-300 invalid:ring-2 invalid:ring-red-400 focus:ring-2 focus:ring-sky-300"
              />
            </div>
            ...
            <button
              type="submit"
              class="w-full rounded-md bg-sky-600 py-3 px-6 focus:bg-sky-700 active:bg-sky-500"
            >
